...
#to check if the assignment and days are empty
...
if [[ $run_script =~ ^[Yy$]$ ]]; then
   ...
   ./startup.sh
    ...
    echo "You can run the script later by executing './startup.sh' inside the '$dir' directory."
fi